...
- [dbchat-4.2.0-basic.jar](https://github.com/skanga/dbchat/releases/download/v4.1.0/dbchat-4.2.0-basic.jar) - Basic version (PostgreSQL, SQLite, H2, HSQLDB, CSV). We recommend that you start here.
